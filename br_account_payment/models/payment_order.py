...
class PaymentOrderLine(models.Model):
    ...
    journal_id = fields.Many2one(
        ...
        related="payment_order_id.journal_id",
    )
...
class PaymentOrder(models.Model):
    ...
    user_id = fields.Many2one(
        "res.users", string="Responsável", required=True
    )
    journal_id = fields.Many2one(
        "account.journal", string="Modo de Pagamento", required=True
    )
